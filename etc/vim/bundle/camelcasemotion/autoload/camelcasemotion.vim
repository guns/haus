...
function! s:Move( direction, count, mode )
	...
	if a:direction == 'e'
	    ...
	    " end of ...
	    " number | ACRONYM followed by CamelCase or number | lowercase followed by CamelCase, ACRONYM, or number | CamelCase | underscore_notation or dashed-word | non-keyword | word
	    ...
	    " beginning of ...
	    " word | empty line | non-keyword after whitespaces | non-whitespace after word | number | start of ACRONYM followed by CamelCase or number | CamelCase | underscore or dashed followed by ACRONYM, Camel, lowercase or number
