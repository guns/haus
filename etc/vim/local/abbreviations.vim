...
let cmds = '
    ...
    \ CapturePane CommandT CommandTBuffer CommandTFlush Ctags DelimitMateReload
    \ DelimitMateSwitch DelimitMateTest DiffOrig DoMatchParen EXtermColorTable
    \ Explore GLVS GPGEditOptions GPGEditRecipients GPGViewOptions GPGViewRecipients
    \ GetLatestVimScripts GetScripts Gitv GundoRenderGraph GundoToggle
    \ HEMan HMan Helptags Hexplore Hitest Interleave KMan LAck LAckAdd Man
    \ MapReadlineUnicodeBindings Mapall MatchDebug MkVimball NERDTree NERDTreeClose
    \ NERDTreeFind NERDTreeFromBookmark NERDTreeMirror NERDTreeToggle NRM NRMulti
    \ NRP NRPrepare NRV NUD NarrowRegion NarrowWindow NetUserPass NetrwClean
    \ NetrwSettings Nexplore NoMatchParen Nread Nsource Nwrite OMan OXtermColorTable
    \ Open Org OrgHyperlinkCopy OrgHyperlinkDescriptiveLinks OrgHyperlinkFollow
    \ OrgHyperlinkInsert OrgHyperlinkLiteralLinks OrgHyperlinkNextLink
    \ OrgHyperlinkPreviousLink OrgTagsRealign Pexplore PreserveMap Preview
    ...
    \ SWP SXtermColorTable Say Scratch Screen ScreenShell ScreenShellAttach
