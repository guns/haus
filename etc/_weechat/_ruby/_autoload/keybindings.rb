...
KEYBINDINGS = {
  'default' => {
    ...
    'ctrl-X'      => nil,
    'ctrl-Xcf'    => '/exec -sh -oc echo "/connect freenode -password=$(pass irc/freenode-guns)"',
    'ctrl-Xcm'    => '/exec -sh -oc echo "/connect mozilla -password=$(pass irc/mozilla-guns)"',
    'ctrl-Xco'    => '/exec -sh -oc echo "/connect oftc"',
    'ctrl-Xh'     => '/input insert /help',
    'ctrl-Xif'    => '/exec -sh -oc echo "/msg NickServ identify guns $(pass irc/freenode-guns)"',
    'ctrl-Xim'    => '/exec -sh -oc echo "/msg NickServ identify $(pass irc/mozilla-guns)"',
    'ctrl-Xio'    => '/exec -sh -oc echo "/msg NickServ identify $(pass irc/oftc-guns) guns"',
    'ctrl-Xj'     => nil,
    ...
    'ctrl-Xr'     => '/RELOADALL',
    'ctrl-Xs'     => '/input insert /list -re\x20',
